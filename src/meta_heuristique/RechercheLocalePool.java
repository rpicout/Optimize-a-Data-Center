...
public class RechercheLocalePool {
	...
	public Data getSolutionRechercheLocalePool (Data dataHeuristique, RowEquivalente heuristique) {

		System.out.println("Début recherche locale par pool");
		...
		System.out.println("Fin recherche locale par pool");
